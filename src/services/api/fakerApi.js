class FakerApi {
    routes = {
        ...
        '/posts/create': function (instance, {title, content, name, createDate}) {
            instance._setPost({ title, content, name, createDate })
            return {
                success: true,
        ...
        '/comments/create': function (instance, {post_id, comment: {content, name, createDate}}) {
            instance._setComment(post_id, { content, name, createDate})
            return {
                success: true,
    ...
    _setPost(post)
    {
        ...
        if (!post.id) {
            ...
            posts = posts.map((postMap) => postMap.id === post.id ? post: postMap)
        }
